...
layout: styleguide
title: Ansible Tower - Physical & Environmental Protection
...
<center>
  <table width="85%">
    ...
    {% for control_response in site.data.components.ansible-tower.policies.PE-Physical_and_Environmental_Protection.component %}
    <tr>
