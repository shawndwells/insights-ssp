...
layout: styleguide
title: Ansible Tower - System & Services Acquisition
...
<center>
  <table width="85%">
    ...
    {% for control_response in site.data.components.ansible-tower.policies.SA-System_and_Services_Acquisition.component %}
    <tr>
