...
layout: styleguide
title: Ansible Tower - Systems & Communications Protection
...
<center>
{% for control_response in site.data.components.ansible-tower.policies.SC-Systems_and_Communications_Protection.component %}
