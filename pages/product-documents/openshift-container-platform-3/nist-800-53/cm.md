...
lead: |
  Some desc of Configuration Management will go here
subnav:
...
<center>
{% for control_response in site.data.components.openshift-container-platform-3.policies.CM-Configuration_Management.component %}
