...
layout: styleguide
title: OpenShift Container Platform 3.x - Physical & Environmental Protection
category: Product Documents
lead: |
  Some desc of Physical & Environmental Protection will go here
subnav:
...
<center>
{% for control_response in site.data.components.openshift-container-platform-3.policies.PE-Physical_and_Environmental_Protection.component %}
