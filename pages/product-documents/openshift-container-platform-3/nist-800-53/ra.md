...
lead: |
  Some desc of Risk Assessment will go here
subnav:
...
<center>
{% for control_response in site.data.components.openshift-container-platform-3.policies.RA-Risk_Assessment.component %}
