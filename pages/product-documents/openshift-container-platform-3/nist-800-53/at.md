...
lead: |
  Some desc of Awareness and Training will go here
subnav:
...
<center>
  <table width="85%">
    ...
    {% for control_response in site.data.components.openshift-container-platform-3.policies.AT-Awareness_and_Training.component.component %}
    <tr>
...
<center>
{% for control_response in site.data.components.openshift-container-platform-3.policies.AT-Awareness_and_Training.component %}
