...
layout: styleguide
title: OpenShift Container Platform 3.x - Systems & Communications Protection
category: Product Documents
lead: |
  Some desc of Systems & Communications Protection will go here
subnav:
...
<center>
{% for control_response in site.data.components.openshift-container-platform-3.policies.SC-Systems_and_Communications_Protection.component %}
